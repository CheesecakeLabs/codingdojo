...
/* package codingdojo-0.0.0 */
#define VERSION_codingdojo "0.0.0"
#define MIN_VERSION_codingdojo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "codingdojo-0.0.0-O89NcY1WlHGQ8029dJqHh"
